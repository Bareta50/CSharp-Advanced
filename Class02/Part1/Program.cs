...
using Part1.Entities.Moddels;

Console.WriteLine("Hello, World!");

#region Creating Instances
Developers dev = new Developers(1, "Bob", "Bobsky", 23, "123-123-1234", new List<string> { "JavaScript", "C#", "Java" }, 150);
...
ops.Greet("Students");
Console.WriteLine($"Infrastructure OK: {ops.CheckInfrasructures(200)}");
Console.ResetColor();
